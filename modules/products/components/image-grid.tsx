...
const ImageSlider = ({
  ...
  return (
    <div className={`relative w-full ${className}`}>
      ...
      <div 
        className={`relative ${isMobile ? 'aspect-square' : 'aspect-square'} w-full overflow-hidden rounded-lg bg-zinc-100 dark:bg-zinc-800`}
        onTouchStart={handleTouchStart}
        onTouchMove={handleTouchMove}
        onTouchEnd={handleTouchEnd}
      ...
      {/* Thumbnails - only show on desktop by default */}
